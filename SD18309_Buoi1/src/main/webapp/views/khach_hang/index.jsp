...
<hr>
<form action="/khach-hang/create" method="get">
...
<table class="table table-striped">
    ...
    <c:forEach items="${data.content}" var="kh">
        <tr>
            ...
            <td>${kh.ten}</td>
            <td>${kh.sdt}</td>
            <td><a href="/khach-hang/edit/${kh.id}">Update</a></td>
            <td><a href="/khach-hang/delete/${kh.id}">Delete</a></td>
        </tr>
    </c:forEach>
<%--    <tr>--%>
<%--        <td>1</td>--%>
...
<nav aria-label="Page navigation example" style="margin-left: 30%">
    <ul class="pagination">
        <li class="page-item" aria-disabled="true">
            <a class="page-link" href="/khach-hang/index?keyword=${keyword}&&page=${data.number - 1}">Previous</a>
        </li>
        <c:forEach begin="0" end="${ data.totalPages }" var="page">
            <c:if test="${ page == 0 || page == data.totalPages -1 || ( page >= data.number - 1 && page <= data.number + 1 && page < data.totalPages) }">
                ...
                <li class="page-item">
                    <a class="page-link"
                       href="/khach-hang/index?keyword=${keyword}&&page=${page}">
                            ${ page + 1}
                    </a>
                </li>
            </c:if>
        ...
        <li class="page-item" ><a class="page-link" href="/khach-hang/index?keyword=${keyword}&&page=${data.number + 1}">Next</a></li>
    </ul>
</nav>
</body>
</html>